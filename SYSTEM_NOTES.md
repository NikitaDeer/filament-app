...
6. ✅ FAQ система с поиском, категориями и аккордеоном

### 🔄 В процессе / Планируется:
1. ⏳ Полезная информация (советы по перевозке)
2. ⏳ Улучшение текстового контента на всех страницах
3. ⏳ Добавление галереи изображений
4. ⏳ SEO оптимизация
5. ⏳ Аналитика заказов
6. ⏳ Добавить FAQ ссылку в меню навигации
...
#### 7. `faqs` - FAQ (Вопросы-Ответы)
**Поля:**
- `question` - вопрос
- `answer` - ответ (HTML)
- `category` - категория (Общие вопросы, Стоимость и оплата, и т.д.)
- `order` - порядок сортировки
- `is_published` - опубликован ли
- `is_popular` - популярный вопрос (отображается на главной странице)
...
- `byCategory($category)` - по категории
- `ordered()` - с сортировкой по order

**Страница:** `/faq` с поиском, tabs по категориям, аккордеоном
**Компонент:** `<x-faq-section />` - топ 5 популярных на главной
...
7. **FaqResource** - FAQ (Вопросы-Ответы) (sort: 7)
...
### 16.11.2025 - Добавлена FAQ система
- ✅ Создана таблица `faqs` с полями question, answer, category, order, is_published, is_popular
- ✅ Создана модель Faq со scopes: published(), popular(), byCategory(), ordered()
- ✅ Создан FaqResource в Filament с RichEditor, категориями, toggle колонками, bulk actions
- ✅ Создан FaqSeeder с 20 реальными вопросами-ответами по 6 категориям
- ✅ Создана страница `/faq` с поиском, tabs по категориям, аккордеоном (Alpine.js)
- ✅ Создан компонент `<x-faq-section />` для отображения топ 5 популярных вопросов на главной
- ✅ Обновлен SYSTEM_NOTES.md с документацией по FAQ системе
...
**Миграции:** 29  
**Blade компоненты:** 7  
**Страницы:** 8 (home, about, services, vehicles, prices, contacts, calculator, faq)  
**Helper функции:** 7  
...
1. [x] ~~Создать FAQ систему (таблица, модель, ресурс, страница)~~ ✅ Готово
2. [x] ~~Реализовать блок FAQ на главной странице (топ 5 вопросов)~~ ✅ Готово
3. [ ] Добавить ссылку на FAQ в меню навигации (header/footer)
4. [ ] Добавить Полезную информацию (советы по перевозке)
5. [ ] Улучшить текстовый контент на всех страницах (более живой и убедительный)
6. [ ] Добавить возможность загрузки изображений для всех страниц CMS
7. [ ] Создать Gallery модель для фотогалереи работ
