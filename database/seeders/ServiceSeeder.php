    ...
    public function run(): void
    {
        ...
        $services = [
            ...
            [
                ...
                'description' => 'Полное страхование груза на время перевозки от повреждений и утраты. Стоимость рассчитывается как 0,5% от заявленной стоимости груза.',
                'price' => 500,
                'pricing_type' => 'fixed',
                'is_published' => true,
                'is_popular' => false,
            ...
            [
                'name' => 'Хранение груза',
                'description' => 'Временное хранение груза на охраняемом складе (цена за сутки)',
                'price' => 500,
                'pricing_type' => 'fixed',
                'is_published' => true,
                'is_popular' => false,
