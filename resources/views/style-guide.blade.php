    ...
    <div class="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <section class="mb-12">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                ...
                <div class="text-center">
                    <div class="w-full h-24 rounded-lg bg-green-600 mb-2"></div>
                    <p class="font-medium">Primary</p>
                    <p class="text-sm opacity-70">bg-green-600 (#4CAF50)</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <p class="text-sm opacity-70">bg-accent-500 (Emerald)</p>
                </div>
        ...
        <section class="mb-12">
            ...
            <div class="flex flex-wrap items-center gap-6">
                <button class="btn bg-green-600 text-white px-6 py-2 rounded-lg font-medium hover:bg-primary-600 transition-colors">Primary Button</button>
                ...
                <button class="btn bg-accent-500 text-white px-6 py-2 rounded-lg font-medium hover:bg-accent-600 transition-colors">Accent Button</button>
