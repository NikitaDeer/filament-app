        ...
        <div class="min-h-screen bg-base-100 dark:bg-dark-base-100">
            ...
            <main>
                <div class="fixed top-4 right-4 z-50 sm:top-6 sm:right-6">
                    <button id="theme-toggle" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 transition-all duration-200 hover:scale-110">
