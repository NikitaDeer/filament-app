...
<!-- <section class="bg-slate-800">
  <div class="mx-auto max-w-screen-xl py-8 px-10 sm:py-16 lg:px-6">
    <div class="mx-auto max-w-screen-sm text-center">
      ...
      <p class="mb-6 font-light text-violet-200 md:text-lg">Если у вас остались вопросы, не стесняйтесь обращаться в нашу техподдержку через Telegram. Мы всегда на связи!</p>
...
<!-- <section class="bg-gray-800">
  <div class="mx-auto max-w-screen-xl py-8 px-10 sm:py-16 lg:px-6">
    <div class="mx-auto max-w-screen-sm text-center">
      <h2 class="mb-4 text-4xl font-extrabold leading-tight text-violet-200">Мы Вам позвоним!
      </h2>
      <p class="mb-6 font-light text-violet-200 md:text-lg">После того как вы оставите номер телефона, мы обязательно
        позвоним.</p>

      <a href="#"
        class="mr-2 mb-2 rounded-lg bg-violet-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-violet-700 focus:outline-none focus:ring-4 focus:ring-violet-700">Консультация</a>
    </div>
  </div>
</section> -->