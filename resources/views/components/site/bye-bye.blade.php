<section class="bg-gray-50 dark:bg-neutral-900">
  <div class="mx-auto max-w-screen-xl py-12 px-6 sm:py-16 lg:px-8">
    <div class="mx-auto max-w-screen-md text-center">
      <!-- Заголовок -->
      <h2 class="mb-4 text-4xl font-extrabold leading-tight text-primary-600 dark:text-primary-400">
        Остались вопросы?
      </h2>

      <!-- Описание -->
      <p class="mb-8 text-lg font-light text-gray-700 dark:text-gray-300">
