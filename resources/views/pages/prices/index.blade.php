  ...
  <section class="bg-gradient-to-br from-green-50 to-white py-16 dark:from-gray-800 dark:to-gray-900 sm:py-24">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="rounded-xl bg-white p-6 shadow-md dark:bg-gray-800">
          <div class="flex items-center">
            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-teal-100 dark:bg-teal-900/30">
            ...
            <h3 class="ml-3 text-lg font-semibold text-gray-900 dark:text-white">Страхование груза</h3>
          </div>
          <p class="mt-3 text-sm text-gray-600 dark:text-gray-400">
